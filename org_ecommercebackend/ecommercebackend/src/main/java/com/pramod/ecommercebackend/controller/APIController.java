package com.pramod.ecommercebackend.controller;

import com.pramod.ecommercebackend.config.JwtUtil;
...
import com.pramod.ecommercebackend.service.CartItemService;
import com.pramod.ecommercebackend.service.CheckOutService;
import com.pramod.ecommercebackend.service.JwtUserDetailsService;
import com.pramod.ecommercebackend.service.ProductService;
import com.pramod.ecommercebackend.service.UserService;
...
public class APIController {
    ...
    public APIController(UserService userService, ProductService productService, CartItemService cartItemService, CheckOutService checkOutService) {
    ...
    @DeleteMapping("/users/{id}/cart/remove")
    public ResponseEntity<User> deleteUserCartItems (@PathVariable("id") Long id) {
        cartItemService.deleteUserCartItems(id);
        return new ResponseEntity<>(userService.getUser(id), HttpStatus.OK);
    }
    ...
    public ResponseEntity<List<Order>> getUserOrders (@PathVariable("userId") Long id) {
    	List<Order> orders = checkOutService.getUserOrders(id);
    	return ResponseEntity.ok(orders);
	}
 
    @PostMapping("/orders/{userId}")
    public ResponseEntity<Order> placeUserOrderOrders (@PathVariable("userId") Long id, @RequestBody OrderDTO order) {
    	Order obj = checkOutService.placeOrder(order, id);
