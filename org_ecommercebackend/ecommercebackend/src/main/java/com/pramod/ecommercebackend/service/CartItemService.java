...
import com.pramod.ecommercebackend.exceptions.CartItemAlreadyExistsException;
import com.pramod.ecommercebackend.exceptions.CartItemDoesNotExistsException;
import com.pramod.ecommercebackend.model.cart.CartItem;
import com.pramod.ecommercebackend.repo.CartItemRepository;
...
public class CartItemService {
    ...
    public void deleteUserCartItems (Long userId) {
        ...
        if(!deleted) {
            ...
            throw new CartItemDoesNotExistsException(
                    "Cart item w/ user id " + userId +" does not exist."
            );	
        }
    }
